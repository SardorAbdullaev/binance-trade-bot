...
from .mongo_db import MongoBinanceTraderManager
...
def main():
    ...
    mongo_manager = MongoBinanceTraderManager(mongodb_client, logger)
    ...
    if strategy is None:
        ...
        return
    trader = strategy(manager, db, logger, config, mongo_manager=mongo_manager)
